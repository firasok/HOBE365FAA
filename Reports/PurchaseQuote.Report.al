report 51203 "HBR Purchase - Quote"
{
    //<NCO> 
    // Netcompany modification of Report 404 for HBR 
    //</NCO>

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HBRPurchaseQuote.rdl';
    Caption = 'HBR Purchase - Quote';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterHeading = 'HBR Purchase Quote';
            ...
            column(GLNCaptionLbl; GLNCaptionLbl) { }
            column(GLNValue; CompanyInfo.GLN) { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        // <NCO>
                        column(Variant_Code; "Purchase Line"."Variant Code") { }
                        // </NCO>
