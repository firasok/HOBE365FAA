report 51202 "HBR Purchase - Order"
{
    WordLayout = './Layouts/HBRPurchaseOrder.docx';
    Caption = 'HBR Purchase - Order';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterHeading = 'HBR Purchase - Order';
            ...
            column(CompanyInfoGLNCaptionLbl; GLNCaptionLbl) { }
            ...
            //<NCO>
            column(ShipToTlfNo; Location."Phone No.") { }
            column(ShipToEmail; Location."E-Mail") { }
            //</NCO>
            ...
            column(Sales_Invoice_Header_Shortcut_Dimension_caption; "Purchase Header".fieldCaption("Shortcut Dimension 1 Code"))
            {
            }
            ...
            column(DepartmentPhone; Location."Phone No.")
            {
            }
            column(DepartmentEmail; Location."E-Mail")
            {
            }
            ...
            column(VendorPhoneNoLbl; Vendor.FIELDCAPTION("Phone No.")) { }

            column(VendorOurAccountNo; Vendor."Our Account No.") { }
            column(VendorOurAccountNoLbl; Vendor.FIELDCAPTION("Our Account No.")) { }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                // <NCO>
                column(VariantCodeLbl; FieldCaption("Variant Code")) { }
                column(Variant_Code; "Variant Code") { }

                column(Vendor_Item_No_; "Vendor Item No.") { }
                column(VendorItemNoLbl; FieldCaption("Vendor Item No.")) { }
    ...
    var
        ...
        Vendor: Record Vendor; //<NCO>
        Location: Record Location; //<NCO>
        No_PurchLine_Lbl: Label 'HBR Item No.';
