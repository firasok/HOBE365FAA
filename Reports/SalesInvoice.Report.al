report 54206 "Sales - Invoice HBR"
{
    //<NCO> 
    // Netcompany modification of Report 206 for HBR 
    //</NCO>
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    //<NCO>
                    column(CompanyInfo__Email_; CompanyInfo."E-Mail")
                    {
                    }
                    column(CompanyInfo__Email_caption; CompanyInfo.fieldCaption("E-Mail"))
                    {
                    }
                    //</NCO>
                    ...
                    // <NCO>
                    column(CompanyInfo__Bank_Registration_No__; CompanyInfo."Bank Branch No.")
                    {
                    }
                    column(CompanyInfo__Bank_Registration_No__Caption; BankRegistrationCaptionLbl)
                    {
                    }
                    column(CompanyInfo__SWIFT_NO_; CompanyInfo."SWIFT Code")
                    {
                    }
                    column(CompanyInfo__SWIFT_NO_Caption; CompanyInfo.fieldCaption("SWIFT Code"))
                    {
                    }
                    column(CompanyInfoIBAN; CompanyInfo.IBAN)
                    {
                    }
                    column(CompanyInfoIBANCaption; CompanyInfo.fieldCaption(IBAN))
                    {
                    }
                    column(ExternalDocumentNoSalesInvHdr; "Sales Invoice Header"."External Document No.")
                    {
                    }
                    column(ExternalDocumentNoCaption; AltExternalDocumentNoLbl)
                    {
                    }
                    // </NCO>
                    ...
                    //<NCO>
                    column(Sales_Invoice_Header__Shortcust_Dimension_1_Name; DepartmentName)
                    {
                    }
                    column(Sales_Invoice_Header_Shortcut_Dimension_caption; "Sales Invoice Header".fieldCaption("Shortcut Dimension 1 Code"))
                    {
                    }
                    column(DepartmentAddr_1_; DepartmentAddr[1])
                    {
                    }
                    column(DepartmentAddr_2_; DepartmentAddr[2])
                    {
                    }
                    column(DepartmentAddr_3_; DepartmentAddr[3])
                    {
                    }
                    column(DepartmentAddr_4_; DepartmentAddr[4])
                    {
                    }
                    column(DepartmentAddr_5_; DepartmentAddr[5])
                    {
                    }
                    column(DepartmentAddr_6_; DepartmentAddr[6])
                    {
                    }
                    column(DepartmentAddr_7_; DepartmentAddr[7])
                    {
                    }
                    column(DepartmentAddr_8_; DepartmentAddr[8])
                    {
                    }
                    column(DepartmentPhone; RespCenter."Phone No.")
                    {
                    }
                    column(DepartmentEmail; RespCenter."E-Mail")
                    {
                    }
                    column(PaymentTerms_Description_Footer; PaymentTerms.Description)
                    {
                    }
                    column(PaymentTerms_DescriptionCaption_Footer; PaymentTerms.FieldCaption(Description))
                    {
                    }
                    //</NCO>
            ...
            var
                Handled: Boolean;
                DimensionValue: Record "Dimension Value"; //<NCO>
                FIKMgt: Codeunit FIKManagement; //<NCO>
            ...
            begin
                ...
                //OnGetReferenceText("Sales Invoice Header", ReferenceText, Handled); //<NCO> See comment below

                Handled := false;
                //OnGetDocumentReferenceText("Sales Invoice Header", DocumentReference, DocumentReferenceTxt, Handled); //<NCO> See comment below

                // <NCO>
                //Above does only work when the report is named "Sales - Invoice"
                //See https://github.com/microsoft/ALAppExtensions/blob/master/AddOns/FIK/app/src/codeunits/Cod13657.FIKSubscribers.al - line 250
                //Therfore below is done instead of OnGetDocumentReferenceText
                DocumentReferenceTxt := '';
                DocumentReference := FIKMgt.GetFIK71String("Sales Invoice Header"."No.");
                IF DocumentReference <> '' THEN
                    DocumentReferenceTxt := DocumentReferenceCaptionTxt;
                // <NCO>
                ...
                if not DimensionValue.IsEmpty then begin
                    ...
                    //Find RespCenter from Global Dimension Code.
                    RespCenter.SetRange("Global Dimension 1 Code", DimensionValue."Code");
                    if not RespCenter.IsEmpty then begin
                        RespCenter.FindFirst();
                        //Format address from RespCenter and add to DepartmentAddr
                        FormatAddr.RespCenter(DepartmentAddr, RespCenter);
                    end;
    ...
    var
        ...
        DepartmentAddr: array[8] of Text[50]; //<NCO>
        OrderNoText: Text[80];
        ...
        BankRegistrationCaptionLbl: Label 'Reg. No.'; //<NCO>
        DepartmentName: Text[50]; //<NCO>
        AltExternalDocumentNoLbl: Label 'Order No.'; //<NCO>
        AltPostingDateCaption: label 'Invoice Date'; //<NCO> Fakturadato
        DocumentReferenceCaptionTxt: Label 'FIK Code', Comment = 'Translate to FIK-kode (FIK is danish abbreviation).';
        VariantCodeCaption: Label 'Variant Code'; // <NCO>
