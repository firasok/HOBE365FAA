report 54911 "Service - Invoice HBR"
{
    //<NCO> 
    // Netcompany modification of Report 5911 for HBR 
    //</NCO>

    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/ServiceInvoice.rdl';
        ...
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoBankRegistrationNo; CompanyInfo."Bank Branch No.")
                    {
                    }
                    column(CompanyInfoBankRegistrationNoCaption; BankRegistrationCaptionLbl)
                    {
                    }
                    column(CompanyInfoSWIFTNO; CompanyInfo."SWIFT Code")
                    {
                    }
                    column(CompanyInfoSWIFTNOCaption; CompanyInfo.fieldCaption("SWIFT Code"))
                    {
                    }
                    ...
                    column(Sales_Invoice_Header_Shortcut_Dimension_caption; "Service Invoice Header".fieldCaption("Shortcut Dimension 1 Code"))
                    {
                    }
                    ...
                    column(PaymentTerms_DescriptionCaption_Footer; PaymentTermsCaption)
                    {
                    }
                    //</NCO>
            ...
            begin
                ...
                DocumentReference := FIKMgt.GetFIK71String("Service Invoice Header"."No.");
    ...
    var
        ...
        DocumentReferenceTxt: Text; //<NCO>
        DocumentReference: Text; //<NCO>
        DocumentReferenceCaptionTxt: Label 'FIK Code', Comment = 'Translate to FIK-kode (FIK is danish abbreviation).'; //<NCO>
        PaymentTermsCaption: Label 'Betalings betingelser';
