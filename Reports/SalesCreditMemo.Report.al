report 54207 "Sales - Credit Memo HBR"
{
    //<NCO> 
    // Netcompany modification of Report 207 for HBR 
    //</NCO>

    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/SalesCreditMemo.rdl';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoIIBAN; CompanyInfo.IBAN)
                    {
                    }
                    column(CompanyInfoIBANaption; CompanyInfo.fieldCaption(IBAN))
                    {
                    }
                    ...
                    column(ExternalDocumentNoSalesInvHdr; "Sales Cr.Memo Header"."External Document No.")
                    {
                    }
                    // </NCO>
                    ...
                    column(BilltoCustNo_SalesCrMemoHeaderCaption; CustomerNoCaption)
                    {
                    }
                    ...
                    column(Sales_Invoice_Header_Shortcut_Dimension_caption; "Sales Cr.Memo Header".fieldCaption("Shortcut Dimension 1 Code"))
                    {
                    }
    ...
    var
        ...
        CustomerNoCaption: Label 'Kundenr.'; //<NCO> //Kundenr. / Customer No.
