report 54912 "Service - Credit Memo HBR"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/ServiceCreditMemo.rdl';
        ...
        dataitem("Service Cr.Memo Header"; "Service Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header_Shortcut_Dimension_caption; "Service Cr.Memo Header".fieldCaption("Shortcut Dimension 1 Code"))
                    {
                    }
