page 51205 "HBR Bookkeeper Role Center"
{

    Caption = 'HBR Bookkeeper', Comment = '{Dependency=Match,"ProfileDescription_HBRBOOKKEEPER"}';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                ShowCaption = false;
                part(Control1901197008; "HBR Bookkeeper Activities")
                {
                    ApplicationArea = Basic, Suite;
                }
                part(ApprovalActivities; "CDC Approval Activities")
                {
                    AccessByPermission = TableData 454 = R;
                    ApplicationArea = All;
                }

                part(Integrations; "HBR Integrations")
                {                   
                    ApplicationArea = All;
                }
            }
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action(IntegrationInvoicingOverviewEmb)
            {
                ApplicationArea = Suite;
                Caption = 'Integration Invoicing Overview';
                Image = Invoice;
                RunObject = Page IntegrationInvoicingOverview;
                ToolTip = 'View the invoices from integrations';
            }
            action(Customers)
            {
                ApplicationArea = Basic, Suite;
        ...
        area(sections)
        {
            group("Documents")
            {
                ...
                action(JobInvoices)
                {
                    ...
                    Image = PostedOrder;
                    RunObject = Page "Job Invoices";
                    ToolTip = 'Open the list of Job invoices.';
                }
                action("Service Orders")
                {
                    ...
                    ToolTip = 'Open the list of service orders.';
                }
                action("Service Invoices")
                {
                    ...
                    ToolTip = 'Open the list of Service Invoices.';
                }
            }
            group(Action22)
            {
                ...
                action(RequestsToApprove)
                {
                    ...
                    Image = Approvals;
                    RunObject = Page "CDC Purch. Approval Entries";
            ...
            group(Administration)
            {
                ...
                action(IntegrationInvoicingOverview)
                {
                    ApplicationArea = Suite;
                    Caption = 'Integration Invoicing Overview';
                    Image = Invoice;
