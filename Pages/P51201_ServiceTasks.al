page 51201 "HBRService Tasks"
//<NCO> 
// Copy of Service Tasks table. To add filtration on service tasks.
//</NCO>
{
    ApplicationArea = Service;
    Caption = 'HBR Service Tasks'; //<NCO>
    InsertAllowed = false;
    PageType = Worksheet;
    SaveValues = true;
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field(Description13231; Description)
                {
                    ApplicationArea = All;
                }
        ...
        area(processing)
        {
            group("&Print")
            {
                ...
                action("Service &Tasks")
                {
                    ...
                    begin
                        Clear(ServItemLine);
                        ServItemLine.copy(Rec);

                        REPORT.Run(REPORT::"HBR Service Tasks", true, true, ServItemLine);
                    end;
                }
    ...
    begin
        ...
        if UserId <> '' then begin
            ...
            if not Resource.IsEmpty then begin
                Resource.FindFirst();
                ResourceGroupFilter := Resource."Resource Group No.";
                SetResourceGroupFilter();
                ResourceGroupFilterOnAfterVali();
            end;
        end;
