page 51206 "HBR Budget Role Center"
{
    Caption = 'HBR Budget', Comment = '{Dependency=Match,"ProfileDescription_HBRBUDGET"}';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(HBRActivities; "HBR Activities")
            {
                ApplicationArea = All;
            }
    ...
    actions
    {
        ...
        area(embedding) //Contains the elements in the Navigation Bar (BookMarks)
        {
